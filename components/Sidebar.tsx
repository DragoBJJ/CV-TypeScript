    ...
    <div>
      ...
      <div className="flex my-4 justify-center text-blue-600  md:w-full">
        <a href="https://github.com/DragoBJJ" aria-label="GitHub">
          <FiGithub className="w-12 h-12 mr-5 cursor-pointer transition duration-300 ease-in-out  transform hover:scale-150 text-blue-600" />
        </a>
        <a
          href="https://www.linkedin.com/in/jakub-pawelski-885559228/"
          aria-label="Linkedin"
        >
          <AiFillLinkedin className="w-12 h-12 cursor-pointer transition duration-300 ease-in-out transform hover:scale-150 text-blue-600" />
        </a>
      </div>
      ...
      <div className=" flex flex-col justfify-content items-center  mt-100">
        <button
          ...
          className=" border-2 border-black dark:border-blue-600  w-40 rounded-full my-2 py-2 focus:outline-none hover:bg-black dark:hover:bg-blue-600 hover:text-white transition duration-300 ease-in-out"
        >
          E-mail Me
        </button>
        <button
          onClick={changeTheme}
          className="border-2 border-black dark:border-blue-600 w-40 rounded-full my-2 py-2 hover:bg-black dark:hover:bg-blue-600 mb-4  hover:text-white transition duration-300 ease-in-out"
        >
